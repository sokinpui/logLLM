...
def main():
    ...
    parser.add_argument("--verbose", action="store_true", help="Enable global verbose output")
    parser.add_argument("--test", action="store_true", help="Use prompts/test.json for pm/parse commands")
    parser.add_argument("-j", "--json", type=str, help="Specify a custom JSON file path for pm/parse commands")
